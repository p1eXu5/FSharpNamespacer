...
{
    internal sealed class WrapToTypeAction : ChangeLineAction
    {
        private readonly IReadOnlyCollection<string> _suggestedNameSegments;
        private readonly int _indentSize;
        private readonly string _typeName;

        public WrapToTypeAction(
            ...
            : base(trackingSpan, originKeyword, originLine, suggestedNameSegments)
        {
            ...
            _typeName = suggestedNameSegments.Last();
        }
        ...
        public override string DisplayText
        {
            get
            {
                ...
                _displayText = $"namespace {NamespaceName} ... type {_typeName}() =".TrimEnd();
        ...
        protected override TextBlock GetReplacementTextBlock()
        {
            ...
            AddPlusSign();
            replacementTextBlock.Inlines.Add(new Run() { Text = "type ", Foreground = _keywordBrush });
            replacementTextBlock.Inlines.Add(new Run() { Text = _typeName, Foreground = _typeBrush });
